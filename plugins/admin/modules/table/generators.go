...
import (
	...
	"github.com/huyrun/go-admin/plugins/admin/modules/tools"
	"github.com/huyrun/go-admin/template"
	"github.com/huyrun/go-admin/template/types"
	"github.com/huyrun/go-admin/template/types/action"
	"github.com/huyrun/go-admin/template/types/form"
	selection "github.com/huyrun/go-admin/template/types/form/select"
...
func (s *SystemTable) GetGenerateForm(ctx *context.Context) (generateTool Table) {
	...
	formList.AddField(lgWithScore("extra import package", "tool"), "extra_import_package", db.Varchar, form.Select).
		FieldOptions(types.FieldOptions{
			...
			{Text: "log", Value: "log"},
			{Text: "fmt", Value: "fmt"},
			{Text: "github.com/huyrun/go-admin/modules/db/dialect", Value: "github.com/huyrun/go-admin/modules/db/dialect"},
			{Text: "github.com/huyrun/go-admin/modules/db", Value: "github.com/huyrun/go-admin/modules/db"},
			{Text: "github.com/huyrun/go-admin/modules/language", Value: "github.com/huyrun/go-admin/modules/language"},
			{Text: "github.com/huyrun/go-admin/modules/logger", Value: "github.com/huyrun/go-admin/modules/logger"},
		}).
		FieldDefault("").
