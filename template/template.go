...
type Component interface {
	...
	//
	// See:
	// https://github.com/huyrun/go-admin/blob/master/template/login/theme1.tmpl#L32
	// https://github.com/huyrun/go-admin/blob/master/template/login/list.go
	GetAssetList() []string
